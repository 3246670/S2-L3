...
console.log(femaleCharacters);
 ...
 switch(charactersNames.eye_color){
    case"blue":
    eye_color.blue.push(charactersNames);
    case"yellow":
    eye_color.yellow.push(charactersNames);
    case "brown":
        eye_color.brown.push(charactersNames);
        case"red":
        eye_color.red.push(charactersNames);
        case"blue-gray":
        eye_color["blue-gray"].push(charactersNames);
        default:
            console.log("Unknow eye color for character:" + charactersNames);
    }
}
